...
function (_Annotation) {
  ...
  _createClass(WidgetAnnotation, [{
    ...
    value: function getOperatorList(evaluator, task, renderForms, forceRenderSigAnnot) {
      ...
      return _get(_getPrototypeOf(WidgetAnnotation.prototype), "getOperatorList", this).call(this, evaluator, task, renderForms, forceRenderSigAnnot);
    }
  }]);
  ...
  _createClass(TextWidgetAnnotation, [{
    ...
    value: function getOperatorList(evaluator, task, renderForms, forceRenderSigAnnot) {
      if (renderForms || this.appearance) {
        return _get(_getPrototypeOf(TextWidgetAnnotation.prototype), "getOperatorList", this).call(this, evaluator, task, renderForms, forceRenderSigAnnot);
      }
