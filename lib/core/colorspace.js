...
var ColorSpace = exports.ColorSpace = /*#__PURE__*/function () {
  ...
  return _createClass(ColorSpace, [{
    key: "getRgb",
...
var AlternateCS = /*#__PURE__*/function (_ColorSpace) {
  function AlternateCS(numComps, base, tintFn) {
    ...
    _this = _callSuper(this, AlternateCS, ['Alternate', numComps]);
    _this.base = base;
    _this.tintFn = tintFn;
...
var PatternCS = /*#__PURE__*/function (_ColorSpace2) {
  function PatternCS(baseCS) {
    ...
    _this2 = _callSuper(this, PatternCS, ['Pattern', null]);
    _this2.base = baseCS;
    return _this2;
  }
...
var IndexedCS = /*#__PURE__*/function (_ColorSpace3) {
  function IndexedCS(base, highVal, lookup) {
    ...
    _this3 = _callSuper(this, IndexedCS, ['Indexed', 1]);
    _this3.base = base;
...
var DeviceCmykCS = function DeviceCmykCSClosure() {
  ...
  var DeviceCmykCS = /*#__PURE__*/function (_ColorSpace6) {
    function DeviceCmykCS() {
      ...
      return _callSuper(this, DeviceCmykCS, ['DeviceCMYK', 4]);
    }
...
var CalGrayCS = function CalGrayCSClosure() {
  ...
  var CalGrayCS = /*#__PURE__*/function (_ColorSpace7) {
    function CalGrayCS(whitePoint, blackPoint, gamma) {
      ...
      _this4 = _callSuper(this, CalGrayCS, ['CalGray', 1]);
      if (!whitePoint) {
...
var CalRGBCS = function CalRGBCSClosure() {
  ...
  var CalRGBCS = /*#__PURE__*/function (_ColorSpace8) {
    function CalRGBCS(whitePoint, blackPoint, gamma, matrix) {
      ...
      _this5 = _callSuper(this, CalRGBCS, ['CalRGB', 3]);
      if (!whitePoint) {
...
var LabCS = function LabCSClosure() {
  ...
  var LabCS = /*#__PURE__*/function (_ColorSpace9) {
    function LabCS(whitePoint, blackPoint, range) {
      ...
      _this6 = _callSuper(this, LabCS, ['Lab', 3]);
      if (!whitePoint) {
