        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            if (isAnnotationRenderable(annotation, intent)) {
              opListPromises.push(annotation.getOperatorList(partialEvaluator, task, renderInteractiveForms, forceRenderSigAnnot));
            }
          }
        } catch (err) {
          _iterator2.e(err);
...
var PDFDocument = exports.PDFDocument = /*#__PURE__*/function () {
